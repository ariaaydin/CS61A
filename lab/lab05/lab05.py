def couple(s, t):
    ...
    for element in range(0, len(s)):
        aylmao = list()
        aylmao.append(s[element])
        aylmao.append(t[element])
        biggerlist.append(aylmao)
    return biggerlist
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    city_c= make_city("city c", lat, lon)
    op1 = distance(city_a, city_c)
    op2 = distance(city_b, city_c)
    if op1 < op2:
